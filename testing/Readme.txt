...
5. Copyright
	...
	entire package.
		...
		/		dht.m		Quasi-discrete Hankel transform of integer
				...
				examples.m	Application examples
...
7. History
   ...
   • July 29, 2009
	Bug fix in "dht.m" thanks to Nicolas Grisouard. Hankel transforms of order 1
	or higher require to take care of the first root (zero) of the Bessel functions
	of the first kind when calculating the transformation kernel (avoid division by
	zero).
...
8. Download
	...
	Optimized MATLAB routines are available online at:
		   ...
		   http://wwwuser.gwdg.de/~mleuten/MATLABToolbox/
